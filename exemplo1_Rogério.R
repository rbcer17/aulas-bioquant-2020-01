...
#Para calcular a media e variancia e necessario usar o comando "Mean", eu tentei puxar a media diretamente do objeto trees e nao funcionou
#por isso e necessario utilizar o comando mean, colocar o objeto trees entre parentesis junto com o simbolo "$" para selecionar o vetor especifico
#Depois é só repetir o processo para cada vetor pedindo a media
#o mesmo processo deve ser feito usando o comando "var()"
#Ao final de cada comando para ativar é preciso apertar as teclas "Ctrl e Enter".
